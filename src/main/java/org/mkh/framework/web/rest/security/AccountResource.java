...
import org.mkh.framework.service.dto.security.PasswordChangeDTO;
...
import org.mkh.framework.web.rest.errors.*;
import org.mkh.framework.web.rest.vm.KeyAndPasswordVM;
import org.mkh.framework.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
     ...
     * @throws RuntimeException 500 (Internal Server Error) if the user couldn't be enabled
     */
    @GetMapping("/activate")
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        final String userLogin = SecurityUtils.getCurrentUserName().orElseThrow(() -> new InternalServerErrorException("Current user login not found"));
