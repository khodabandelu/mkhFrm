...
export class MkhLanguageHelper {
    ...
    getLanguage(lang: string): Promise<any> {
        return Promise.resolve(this.findLanguageFromKeyPipe.get(lang));
    }

    getAllWithInfo() :Promise<any> {
        return Promise.resolve(this.findLanguageFromKeyPipe.all());
    }
